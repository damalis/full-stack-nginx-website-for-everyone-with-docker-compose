...
echo "================================================================="
echo "|                                                               |"
echo "|  full-stack-nginx-webserver-for-everyone-with-docker-compose  |"
echo "|                     by Erdal ALTIN                            |"
echo "|                                                               |"
echo "================================================================="
sleep 2
...
if [ -x "$(command -v docker)" ] && [ -x "$(command -v docker-compose)" ]; then
	...
	# installing web and the other services
	...
	then
		...
		echo ""
		echo "Error! could not installed web and the other services with docker-compose" >&2
		exit 1
	fi
else
	echo ""
